...
ft_df = pd.merge(ft_df, annotation, how="left", left_on='Feature', right_on="ensembl_gene_id")
ft_df = ft_df.drop('ensembl_gene_id', axis=1)
ft_df.rename(columns={'wikigene_name': 'Gene_symbol', 'wikigene_description': 'Annotation'}, inplace=True)
