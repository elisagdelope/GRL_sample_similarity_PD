...
if __name__ == '__main__':
    ...
    for fold, (train_msk, test_msk, val_msk) in enumerate(zip(*k_fold(X, y, folds))):
        ...
        X_processed = pd.DataFrame(data=X_processed, columns=feat_names, index=metab.index) # if undersampling: metab.index[rus.sample_indices_]
        # build network
